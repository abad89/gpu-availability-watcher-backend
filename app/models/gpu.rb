...
class Gpu < ApplicationRecord
    ...
    def self.get_gpu(sku)
        ...
        puts this_gpu["name"]
        new_gpu = Gpu.create(name: this_gpu["name"], salePrice: this_gpu["salePrice"], sku: this_gpu["salePrice"], onlineAvailability: this_gpu["onlineAvailability"], url: this_gpu["url"], largeImage: this_gpu["largeImage"])
    end
